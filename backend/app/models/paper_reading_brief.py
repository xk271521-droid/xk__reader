...
class PaperReadingBrief(Base):
    """The one durable, full-paper quick-read result for an owned paper."""

    __tablename__ = "paper_reading_briefs"
    ...
    paper: Mapped["Paper"] = relationship(back_populates="reading_brief")

    __table_args__ = (
        Index("ix_paper_reading_briefs_user_status_updated", "user_id", "status", "updated_at"),
    )
